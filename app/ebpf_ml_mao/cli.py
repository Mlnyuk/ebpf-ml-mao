...
from .api import load_ingest_index, rebuild_ingest_index, serve_api
...
from .transport import drain_spool, post_report, prune_spool, ship_report, spool_status
...
def build_parser() -> argparse.ArgumentParser:
    ...
    for name in ("phase1", "phase2", "phase3", "phase4", "phase5"):
        pass
...
def main() -> int:
    ...
    if args.command == "api":
        serve_api(args.host, args.port, registry_path=args.registry_path, ingest_dir=args.ingest_dir, shared_token=args.shared_token); return 0
